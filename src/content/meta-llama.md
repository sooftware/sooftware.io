...
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/5b17e245-ba40-4f5f-9f92-f8492252c9d6" height=300>
...
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/9da0cc81-19c7-4d6f-a58f-67f2bf1e5b0a" width=500>
...
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/fac535ca-8522-4549-92cb-d5acedd8991e">

Meta는 LLaMA-1에 이어 2023년 7월 LLaMA-2를 공개했습니다. 모델 사이즈는 7B, 13B, 70B로 상당히 큰 사이즈의 모델들을 공개했습니다. LLM 시대의 시작을 알렸던 GPT-3가 175B이였던걸 감안하면, 70B이라는 크기는 상당한 사이즈입니다. (한국어 모델 중 가장 큰 사이즈의 사전학습 모델은 12.8B의 Polyglot-Ko 모델입니다.) Meta의 LLaMA-2 공개 및 테크니컬 리포트까지 공개하면서 전세계 LLM 연구자들에게 많은 기회의 창을 열어주었습니다. LLaMA-2 공개 이후 국내외로 하루하루 새로운 모델과 논문이 쏟아져 나오고 있으며, 오픈소스 진영이 불타오를 수 있도록 기름을 부어준 격이 됐습니다. (국내에는 준번님이 공개해준 LLaMA-2-Ko가 대표적입니다.) 이러한 Meta의 행보는 ChatGPT를 만든 OpenAI나 발빠르게 ChatGPT와 유사한 Bard를 내놓은 Google의 행보와는 아주 대조적입니다. 🤔
  
## 그렇다면 Meta는 왜 LLaMA를 공개하기로 했을까?
  
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/17ba722e-731c-42c8-a250-fce2645b9b5e" height=450>
...
지금 LLM 시장은 큰 격차로 OpenAI가 단독 선두로 달리고 있다고 볼 수 있습니다. ChatGPT 등장전, Google, OpenAI, Meta, Microsoft가 비등비등한 상황이였다면, ChatGPT 등장 이후로는 아래와 같은 상황이였습니다.  

- OpenAI : 단독 선두
- Microsoft : OpenAI에 투자. OpenAI의 최대주주. 사실상 최대 승리자.
- Google : Bard를 내놓으며 OpenAI 따라잡기 진행중
- Meta : 포지션 애매.. OpenAI와 기술적 격차도 큼
  
이러한 상황에서 사실상 Meta가 갑자기 Google과 OpenAI를 제치며 LLM 시장을 점유하는건 사실상 어려워보였습니다. 이미 커져버린 기술적 격차를 어떻게 해소할지도 내부적으로 많은 고민이 있었을 것으로 보입니다.
  
### 2. LLaMA 시리즈를 공개함으로써, OpenAI의 독점을 막을 수 있다.

<img src="https://github.com/sooftware/sooftware.io/assets/42150335/52f804a9-b7a9-41b9-bf03-f5373ed22820" height=400>
...
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/2cd2df63-bd47-4f21-983e-c2ac6b2a4b1a" height=400>
...
<img src="https://github.com/sooftware/sooftware.io/assets/42150335/43a1c7c0-75bd-451b-a746-d3bd7bcdf6de" height=350>
...
이렇게 집단지성의 힘을 이용하여 OpenAI와의 기술력 차이를 해소하고, 현재 상황을 뒤집을 기회를 노리고 있다고도 볼 수 있을 것 같습니다. 실제로 Meta에서 LLaMA를 활용한 연구들을 예의주시하며, 각종 연구 결과들을 참고하여 기술을 더 발전시켜나가고 있다고 합니다. 😎
  
### 4. 우수한 인력 확보

우수한 인력 확보는 기업에게 가장 중요한 일 중 하나입니다. 빅테크 기업들에서 오픈소스를 공개하는 가장 큰 이유가 인재 확보를 위해서라고 하죠. Meta 입장에서도 LLaMA와 같은 모델을 공개하며 오픈소스에 기여한다는 좋은 이미지와 함께 OpenAI의 LLM 기술 독점에 불만을 가지고 있는 전세계의 우수한 리서쳐들에게 어필을 할 수 있습니다.   

---  

'Meta는 왜 LLaMA를 공개할까?'라는 주제에 대해 제 생각을 써봤습니다. 위 내용은 제 개인적인 견해이며, 사실과는 많은 차이가 있을 수 있는 점 참고해주시면 감사하겠습니다. 😁

## LLaMA-3 학습중, 그리고 오픈소스 공개?!

몇일 전 저커버그의 인터뷰에서 LLaMA-3에 대한 언급이 있었습니다. 내용을 정리하자면 아래와 같습니다.  
...
34만대의 H100 구매는 정말 어메이징하네요.. 어쨌든 LLaMA-3를 오픈소스로 공개한다는건 아주 기쁜 소식입니다! 하루 빨리 공개되서 다시 한 번 오픈소스 LLM 진영에 불을 붙여주면 좋겠네요 :)
